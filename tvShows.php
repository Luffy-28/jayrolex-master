...
$page_title = "ReviewHub: TvShows";

require_once ('includes/header.php');
require_once ('includes/database.php');

//select statement
$query_str = "SELECT * FROM tvShows";
					...
					<div class="thumbnail">
						<div class="caption">
							<div class="text-center">
								<a href="moviedetails.php?id=<?php echo $result_row['tvshow_id']?>">
									<img src="<?php echo $result_row['TVshows_image'] ?>" />
								</a>
							</div>
							<h3 class="text-center">
								<?php
								echo "<a href='moviedetails.php?id=" . $result_row['tvShows_id'] . "'>", $result_row['movie_name'], "</a>";
								?>
							</h3>
						</div>
					</div>
